...
namespace NorthwindDatabase.Context
{
    using System;
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> sp_tbltest(Nullable<int> i)
        {
            var iParameter = i.HasValue ?
                new ObjectParameter("i", i) :
                new ObjectParameter("i", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("sp_tbltest", iParameter);
        }
    
        public virtual int sp_test(Nullable<int> son)
        {
            var sonParameter = son.HasValue ?
                new ObjectParameter("son", son) :
                new ObjectParameter("son", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_test", sonParameter);
        }
    
        public virtual ObjectResult<sp_yeni_Result> sp_yeni(string tablename)
        {
            var tablenameParameter = tablename != null ?
                new ObjectParameter("tablename", tablename) :
                new ObjectParameter("tablename", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_yeni_Result>("sp_yeni", tablenameParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> up_crudtest(Nullable<int> pTrantype, string pProductName, string pProductType, string pCategoryName, Nullable<int> pId)
        {
            ...
            var pProductTypeParameter = pProductType != null ?
                new ObjectParameter("pProductType", pProductType) :
                new ObjectParameter("pProductType", typeof(string));
    
            var pCategoryNameParameter = pCategoryName != null ?
                new ObjectParameter("pCategoryName", pCategoryName) :
                new ObjectParameter("pCategoryName", typeof(string));
    
            var pIdParameter = pId.HasValue ?
                new ObjectParameter("pId", pId) :
                new ObjectParameter("pId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("up_crudtest", pTrantypeParameter, pProductNameParameter, pProductTypeParameter, pCategoryNameParameter, pIdParameter);
        }
    }
}
